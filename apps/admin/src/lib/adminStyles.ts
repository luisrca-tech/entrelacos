export const adminStyles = {
  ...
  form: "my-7 grid gap-[18px] [&_label]:grid [&_label]:gap-2 [&_label]:text-[0.88rem] [&_label]:font-[650] [&_label]:text-admin-graphite [&_input]:min-h-11 [&_input]:min-w-0 [&_input]:w-full [&_input]:rounded-lg [&_input]:border [&_input]:border-admin-line [&_input]:bg-admin-surface [&_input]:px-3 [&_input]:py-2.5 [&_input]:text-admin-ink [&_select]:min-h-11 [&_select]:w-full [&_select]:rounded-lg [&_select]:border [&_select]:border-admin-line [&_select]:bg-admin-surface [&_select]:px-3 [&_select]:py-2.5 [&_textarea]:min-h-11 [&_textarea]:w-full [&_textarea]:rounded-lg [&_textarea]:border [&_textarea]:border-admin-line [&_textarea]:bg-admin-surface [&_textarea]:px-3 [&_textarea]:py-2.5 [&_button]:w-fit [&_button]:min-h-[42px] [&_button]:px-[17px] [&_button]:py-2.5 [&_[data-slot=button]]:w-fit",
  formGrid:
    "my-7 grid min-w-0 grid-cols-[repeat(auto-fit,minmax(min(100%,240px),1fr))] items-end gap-[18px] [&_label]:grid [&_label]:gap-2 [&_label]:text-[0.88rem] [&_label]:font-[650] [&_label]:text-admin-graphite [&_input]:min-h-11 [&_input]:min-w-0 [&_input]:w-full [&_input]:rounded-lg [&_input]:border [&_input]:border-admin-line [&_input]:bg-admin-surface [&_input]:px-3 [&_input]:py-2.5 [&_input]:text-admin-ink [&_textarea]:min-h-11 [&_textarea]:w-full [&_textarea]:rounded-lg [&_textarea]:border [&_textarea]:border-admin-line [&_textarea]:bg-admin-surface [&_textarea]:px-3 [&_textarea]:py-2.5 [&_button]:w-fit [&_button]:min-h-[42px] [&_button]:px-[17px] [&_button]:py-2.5 [&_[data-slot=button]]:w-fit",
  authForm:
