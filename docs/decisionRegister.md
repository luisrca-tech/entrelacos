...
| Scope exclusions | Gifts, checkout, payments, uploads/object storage, WhatsApp, international SMS, individual guest accounts, secret links, self-service CMS, automatic provider/domain operations, and a permanent demo environment/database are out of MVP. | Accepted |
